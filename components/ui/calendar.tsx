...
function CalendarChevron({
  ...
  if (orientation === "up") {
    return <ChevronUpIcon className={cn("size-4", iconClassName)} {...iconProps} />
  }
...
function getCalendarFormatters(
...
function Calendar({
  ...
  const calendarFormatters = getCalendarFormatters(locale, formatters)
  ...
  const calendarComponents = getCalendarComponents(locale, components)
